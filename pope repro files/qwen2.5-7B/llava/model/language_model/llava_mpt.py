...
try:
    # Same defensive guard as llava_llama.py -- avoid crashing if this name
    # is ever already registered (e.g. re-imported, or a future transformers
    # version ships it natively).
