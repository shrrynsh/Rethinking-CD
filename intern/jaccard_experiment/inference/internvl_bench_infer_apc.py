"""APC (Adaptive Plausibility Constraint) inference on LLaVA-Bench using InternVL3-8B.
...
Functionally identical to the LLaVA apc_utils.py (cd_alpha=1.0) and to the Qwen
run, so the beta sweep is comparable across all three models.
"""
import argparse
import json
import os
